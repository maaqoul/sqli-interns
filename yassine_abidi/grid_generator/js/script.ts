...
import {
    ...
    columnGapValue,
    rowGapValue,
    firstDivClickedCoordinates,
    lastDivClickedCoordinates,
    coordinates,
    randomRGB,
    cssCode,
    htmlCode, 
    ...
    from "./env/declarations.js";



document.addEventListener("DOMContentLoaded", function() {

      const divsContainer : Element | null  = document.querySelector(".container");
      if (!divsContainer)
      {
    ...
    //   let htmlCode : Element = document.createElement('div');
        ...
        const elements = divsContainer.querySelectorAll("div");
