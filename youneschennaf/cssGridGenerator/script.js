document.addEventListener("DOMContentLoaded", () => {
    ...
    const appendDiv = (num, start, end) => {
        ...
        newDiv.innerHTML += `.div${num} { grid-area: ${start[0] + 1} / ${start[1] + 1} / ${end[0] + 2} / ${end[1] + 2}; }<br />`;
        return newDiv;
    }
    ...
    const initialiseContainer = () => {
        ...
        cssContainer.appendChild(createSpan(`grid-template-columns: ${gridLayout.style.gridTemplateColumns};`));
        cssContainer.appendChild(createSpan(`grid-template-rows: ${gridLayout.style.gridTemplateRows};`));
        cssContainer.appendChild(createSpan(`grid-column-gap: ${gridLayout.style.columnGap};`));
        cssContainer.appendChild(createSpan(`grid-row-gap: ${gridLayout.style.rowGap};`));
