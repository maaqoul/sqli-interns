...
const inputs = (formElement === null || formElement === void 0 ? void 0 : formElement.querySelectorAll("input")) || document.querySelectorAll("input"); //? The inputs (cols,rows,colgap,rowgap)
const submit = formElement === null || formElement === void 0 ? void 0 : formElement.querySelector("button[type='submit']"); //? code generation button
const reset = formElement === null || formElement === void 0 ? void 0 : formElement.querySelector("button[type='reset']"); //? board reset button
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    reset === null || reset === void 0 ? void 0 : reset.addEventListener("click", resetAll); //=> Add event listeners for resetting the form (inputs and grid items)
    submit === null || submit === void 0 ? void 0 : submit.addEventListener("click", showCode); //=> Add event listener for submitting the form (code generation)
